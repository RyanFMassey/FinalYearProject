...
public class getDamageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			String[] moveTimes = request.getParameterValues("moveTimes");
			String[] moveInfo = request.getParameterValues("moveInfo");
			...
			ArrayList<moveDamList> movDamList = Calculations.moveListToMoveDamList(moveList, moveLevels, moveTimes, moveInfo, startTime, newGod, level, enemyLevel, items, newEnemyGod);
			
			damageResult = Calculations.calculateDamageTime(movDamList);
